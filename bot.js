...
client.on('message', msg => {
  if (msg.content === '$help') {
    ...
    msg.channel.send('-:small_blue_diamond: :large_blue_diamond: `Music Commands` :large_blue_diamond: :small_blue_diamond:-');
    msg.channel.send('→ **$play | To Play A Music**');
    msg.channel.send('→ **$Skip | To Play A Music**');
    msg.channel.send('→ **$stop | To Play A Music**');
    msg.channel.send('→ **$vol | To Hight Volume**');
msg.react("✅")
  }
});
